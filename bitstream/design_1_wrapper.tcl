...
User_Company:SysGen:neonaxitemplate:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: neonaxitemplate_0, and set properties
  set neonaxitemplate_0 [ create_bd_cell -type ip -vlnv User_Company:SysGen:neonaxitemplate:1.0 neonaxitemplate_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins neonaxitemplate_0/s_axis]
  ...
  connect_bd_intf_net -intf_net neonaxitemplate_0_m_axis [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins neonaxitemplate_0/m_axis]
